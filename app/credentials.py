...
CONTENT_SID_TECH_REMINDER_EMPLOYEE_TEXT = os.getenv("CONTENT_SID_TECH_REMINDER_EMPLOYEE_TEXT")
...
missing = [
    ...
    for name, val in {
        ...
        "CONTENT_SID_TECH_REMINDER_EMPLOYEE_TEXT": CONTENT_SID_TECH_REMINDER_EMPLOYEE_TEXT,
    }.items()
    if not val
]
